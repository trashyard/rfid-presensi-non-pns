...
public class Searchbar extends JTextField {
	...
	public Searchbar() {
		...
		iconSearch = new ImageIcon(getClass().getResource("/com/presensikeun/images/icon/textfield/search.png"));
		iconClose = new ImageIcon(getClass().getResource("/com/presensikeun/images/icon/textfield/close.png"));
		iconLoading = new ImageIcon(getClass().getResource("/com/presensikeun/images/icon/textfield/loading.gif"));
